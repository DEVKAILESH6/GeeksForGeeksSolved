# [Array Search](https://www.geeksforgeeks.org/problems/search-an-element-in-an-array-1587115621/1?page=1&category=Arrays,Strings,Java&difficulty=Basic,Easy&sortBy=submissions)
## Easy
